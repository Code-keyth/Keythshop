      ...
      <table class="layui-table">
        ...
        @foreach($orders as $item)
          <tr>
            ...
            <td>
              @if(empty($item->pay_log_sn)) <span class="layui-badge">待支付</span>
              @else

                @switch($item->order_status)
                  @case (0)<span class="layui-badge">待确认</span>@break
                  @case (1)<span class="layui-badge layui-bg-green">已确认</span>@break
