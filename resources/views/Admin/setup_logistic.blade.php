  ...
  <body class="layui-anim layui-anim-up">
    ...
    <div class="x-body">
      ...
      <xblock>
        ...
        <span class="x-right" style="line-height:40px">共有数据：{{$logistics->total()}} 条</span>
      </xblock>
      <table class="layui-table">
        ...
        <tr>
            ...
            <td>{{$item->id}}</td>
            <td>{{$item->shopping_code}}</td>
            <td>{{$item->shopping_name}}</td>
            <td>{{$item->shopping_desc}}</td>
    ...
    <script>
      ...
      function member_stop(obj,id){
          ...
          layer.confirm('确认要'+msg+'吗？',function(index){
              ...
              $.get('/ajax/get_up_state',{'uuid':id,'name':6,'value':value,'type':7},function (ret) {
                 if(ret=='1'){
                     if(value==1){
                         //发异步把用户状态进行更改
                         $(obj).attr('title','启用')
