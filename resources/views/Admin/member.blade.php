  ...
  <body class="layui-anim layui-anim-up">
    ...
    <div class="x-body">
      ...
      <xblock>
        ...
        <span class="x-right" style="line-height:40px">共有数据：{{$members->total()}} 条</span>
      </xblock>
      <table class="layui-table">
        ...
        <tr>
            ...
            <td>{{$item->username}}</td>
            <td>{{$item->email}}</td>
            <td>@if ($item->sex==1)男 @elseif($item->sex==2) 女 @else 保密 @endif</td>
            <td>{{date('Y',time())-$item->birthday}}</td>
            ...
            <td class="td-manage">
                </a><a title="订单明细"  href="member_order?id={{$item->id}}"><i class="layui-icon">&#xe62d;</i></a>
                </a><a title="帐目明细"  href="member_account?id={{$item->id}}"><i class="layui-icon">&#xe705;</i></a>
              @if($item->state==1)
